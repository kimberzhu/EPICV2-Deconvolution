...
- The updated reference atlas includes a total of 5620 probes that are retained from the original 6105 V1 probes in the reference atlas. This equals a 92% retention rate, which is actually higher than overall rate of probe retention between the EPICv1 and v2 (83%). I still have to do some testing to determine how this loss impacts performance. 
